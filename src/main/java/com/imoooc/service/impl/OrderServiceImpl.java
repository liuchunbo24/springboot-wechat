...
import com.imoooc.converter.OrderMaster2OrderDTOConverter;
...
import com.imoooc.repository.OrderDetailRepository;
import com.imoooc.repository.OrdreMasterRepository;
import com.imoooc.service.*;
...
//            cartDTOList.add(cartDTO);
    ...
    public OrderDTO findOne(String orderId) {
        ...
        OrderMaster orderMaster= ordreMasterRepository.findOne(orderId);
        if(orderMaster == null){
    ...
    public Page<OrderDTO> findList(String buyerOpenid, Pageable pageable) {
        Page<OrderMaster> orderMasterPage=ordreMasterRepository.findByBuyerOpenid(buyerOpenid,pageable);
    ...
    public OrderDTO cancel(OrderDTO orderDTO) {
        ...
        BeanUtils.copyProperties(orderDTO,orderMaster);
        OrderMaster updateResult=ordreMasterRepository.save(orderMaster);
    ...
    public Page<OrderDTO> findList(Pageable pageable){
        Page<OrderMaster> orderMasterPage=ordreMasterRepository.findAll(pageable);
